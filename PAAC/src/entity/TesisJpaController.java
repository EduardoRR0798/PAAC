...
public class TesisJpaController implements Serializable {
    ...
    public void create(Tesis tesis) {
        ...
        try {
            ...
            em.persist(tesis);
            if (idProducto != null) {
                idProducto.getTesisCollection().add(tesis);
    ...
    public void edit(Tesis tesis) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getTesisCollection().remove(tesis);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getTesisCollection().add(tesis);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = tesis.getIdProducto();
            if (idProducto != null) {
                idProducto.getTesisCollection().remove(tesis);
                idProducto = em.merge(idProducto);
            }
            em.remove(tesis);
            em.getTransaction().commit();
