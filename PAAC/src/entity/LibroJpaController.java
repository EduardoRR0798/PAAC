...
public class LibroJpaController implements Serializable {
    ...
    public void create(Libro libro) {
        ...
        try {
            ...
            em.persist(libro);
            if (idProducto != null) {
                idProducto.getLibroCollection().add(libro);
    ...
    public void edit(Libro libro) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getLibroCollection().remove(libro);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getLibroCollection().add(libro);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = libro.getIdProducto();
            if (idProducto != null) {
                idProducto.getLibroCollection().remove(libro);
                idProducto = em.merge(idProducto);
            }
            em.remove(libro);
            em.getTransaction().commit();
