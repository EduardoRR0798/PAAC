...
public class CapituloLibroJpaController implements Serializable {
    ...
    public void create(CapituloLibro capituloLibro) {
        ...
        try {
            ...
            if (idProducto != null) {
                idProducto.getCapituloLibroCollection().add(capituloLibro);
    ...
    public void edit(CapituloLibro capituloLibro) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getCapituloLibroCollection().remove(capituloLibro);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getCapituloLibroCollection().add(capituloLibro);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = capituloLibro.getIdProducto();
            if (idProducto != null) {
                idProducto.getCapituloLibroCollection().remove(capituloLibro);
                idProducto = em.merge(idProducto);
            }
