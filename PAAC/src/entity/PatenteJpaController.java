...
public class PatenteJpaController implements Serializable {
    ...
    public void create(Patente patente) {
        ...
        try {
            ...
            em.persist(patente);
            if (idProducto != null) {
                idProducto.getPatenteCollection().add(patente);
    ...
    public void edit(Patente patente) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getPatenteCollection().remove(patente);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getPatenteCollection().add(patente);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = patente.getIdProducto();
            if (idProducto != null) {
                idProducto.getPatenteCollection().remove(patente);
                idProducto = em.merge(idProducto);
            }
            em.remove(patente);
            em.getTransaction().commit();
