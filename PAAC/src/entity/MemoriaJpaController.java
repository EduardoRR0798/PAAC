...
public class MemoriaJpaController implements Serializable {
    ...
    public void create(Memoria memoria) {
        ...
        try {
            ...
            em.persist(memoria);
            if (idProducto != null) {
                idProducto.getMemoriaCollection().add(memoria);
    ...
    public void edit(Memoria memoria) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getMemoriaCollection().remove(memoria);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getMemoriaCollection().add(memoria);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = memoria.getIdProducto();
            if (idProducto != null) {
                idProducto.getMemoriaCollection().remove(memoria);
                idProducto = em.merge(idProducto);
            }
            em.remove(memoria);
            em.getTransaction().commit();
