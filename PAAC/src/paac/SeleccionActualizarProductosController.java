 ...
 */
public class SeleccionActualizarProductosController extends ControladorProductos implements Initializable {
    ...
    private void aceptar(int seleccion) throws IOException {
        switch (seleccion) {
            case 0:
                super.seleccionarArticulo(miembro);
                ((Node) btnCancelar).getScene().getWindow().hide();
                break;
            case 1:
                break;
            case 2:
                break;
            case 3:
                super.seleccionarMemoria(miembro);
                ((Node) btnCancelar).getScene().getWindow().hide();
                break;
            case 4:
                break;
            case 5:
                super.seleccionarPrototipo(miembro);
                ((Node) btnCancelar).getScene().getWindow().hide();
                break;
            case 6:
                break;
