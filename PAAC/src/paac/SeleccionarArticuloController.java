 ...
 */
public class SeleccionarArticuloController implements Initializable {
    ...
    private void abrirVentanaEditarMemoria(Producto p) {
        try {
            ...
            loader.setLocation(getClass().getResource(
                    "ActualizarArticulo.fxml"));
            
            Parent responder = loader.load();
            ControladorActualizarArticulo controller = loader.getController();
